...
_start:
 ...
 dev_open:
	...
	syscall open, ebp,O_RDONLY|O_NONBLOCK
...
;	sys_ioctl ebp,CDROM_DRIVE_STATUS,0
	syscall ioctl, ebp,CDROM_DRIVE_STATUS,0;EMPTY
...
;	sys_ioctl ebp,CDROMCLOSETRAY,0
	syscall ioctl, ebp,CDROMCLOSETRAY,0;EMPTY
 ...
 disc_ok:
	...
	syscall ioctl, ebp,CDROMREADTOCHDR,esp
...
;	sys_open esi,O_CREAT|O_WRONLY|O_TRUNC,0644
	syscall open, esi,O_CREAT|O_WRONLY|O_TRUNC,0x1a4
 ...
 grab:
	...
	syscall ioctl, ebp,CDROMREADTOCENTRY,esp
 ...
 do_grab:				; moving ahead till (start_trk + 1) msf_addr
	...
	syscall ioctl, ebp,CDROMREADAUDIO,esp

	or	eax,eax
	js	near err

	syscall write, edi,[esp+12],CD_FRAMESIZE_RAW
