...
; Build:       see makefile
; Run:         ./mysql-uuid
; Description: Program to get a GUID from mysql. The benefit is that we will have a different one each time we call
;              this program.
...
string:
     ...
     ;assemble with make -dCGI=1, if you want to make a cgi application of this program
%ifdef CGI
