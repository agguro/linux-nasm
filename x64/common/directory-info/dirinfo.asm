; Name:         dirinfo.asm
; Build:        nasm "-felf64" dirinfo.asm -l dirinfo.lst -o dirinfo.o
;               ld -s -melf_x86_64 -o dirinfo dirinfo.o 
;               or use makefile
; Run:          ./dirinfo
; Description:  displays directory entries information of the current working directory
; To-dos:       - the files and directories aren't sorted
;               - better layout
...
_start:
    ...
    syscall     getdents64, qword[fd], buffer, buffer.length
    and         rax, rax
...
section     .text
    ...
    ; The algorithm to change make a mirror of the bits can be found in Hacker's Delight.
