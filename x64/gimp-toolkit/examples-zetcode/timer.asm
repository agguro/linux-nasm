...
; this assembly program isn't the same as the original source since GTK+3.0 is used and the GTK+2.0 example gives a lot of erros (because of the GTK version)
