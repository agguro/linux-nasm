...
;           nasm -f elf32 -o calcleastsquares.o calcleastsquares.asm
;           g++ -m32 -o calcleastsquares calcleastsquares.o main.o
;
; Source:   Modern x86 Assembly Language Programming p.124

global CalcLeastSquares
global LsEpsilon

section .data

    LsEpsilon: dq 1.0e-12                ;epsilon for valid denom test

section .text

; extern "C" bool CalcLeastSquares(const double* x, const double* y, int n, double* m, double* b);
;
