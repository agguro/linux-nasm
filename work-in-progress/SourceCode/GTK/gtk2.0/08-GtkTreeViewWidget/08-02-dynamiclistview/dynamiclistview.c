; Name        : dynamiclistview.asm
;
; Build       : nasm -felf64 -o dynamiclistview.o -l dynamiclistview.lst dynamiclistview.asm
;               ld --dynamic-linker /lib64/ld-linux-x86-64.so.2 -melf_x86_64 -g -o dynamiclistview dynamiclistview.o -lc -lgtk-x11-2.0 -lgdk-x11-2.0 -lgobject-2.0 -lgdk_pixbuf-2.0 -lglib-2.0
;               cd build
;               ../configure
;               make
;
