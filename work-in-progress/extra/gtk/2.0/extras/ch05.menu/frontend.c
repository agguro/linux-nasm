...
static void CreateMainWindow ()
{
    ...
    /* --------------------
       --- Style        ---
       -------------------- */     
    menuColor = CreateSubMenu (menu, "Color");

    menuRed = CreateMenuRadio (menuColor, 
        "Red", &group, GTK_SIGNAL_FUNC (PrintFunc), "Red");

    menuBlue = CreateMenuRadio (menuColor, 
        "Blue", &group, GTK_SIGNAL_FUNC (PrintFunc), "Blue");

    menuGreen = CreateMenuRadio (menuColor, 
        "Green", &group, GTK_SIGNAL_FUNC (PrintFunc), "Green");
