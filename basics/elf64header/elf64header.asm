...
;
; Build:        nasm -f bin -o hello64.bin hello64.nasm
;
...
;
; Remark:
; This program is from the internet (see links above), so all credits goes to the writer(s)
; Compared to the Helloworld example build the usual way the size of this binary is 171 bytes
; while the Helloworld program has 512 bytes.
