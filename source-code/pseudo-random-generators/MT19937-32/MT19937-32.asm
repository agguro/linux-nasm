; Name:         MT19937-32.asm
;
; Build:        nasm "-felf64" MT19937-32.asm -l MT19937-32.lst -o MT19937-32.o
;               ld -s -melf_x86_64 -o MT19937-32 MT19937-32.o
;
; Run:          ./MT19937-32
;
...
[list +]
    ...
    %define NUMBER   1000000       ; number of numbers to generate
