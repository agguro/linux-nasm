; Name:         winsize.asm
;
; Build:        nasm -felf64 winsize.asm -l winsize.lst -o winsize.o
;               ld -s -melf_x86_64 -o winsize winsize.o 
;
; description:  Shows the screen dimension of a terminal in rows/columns.
