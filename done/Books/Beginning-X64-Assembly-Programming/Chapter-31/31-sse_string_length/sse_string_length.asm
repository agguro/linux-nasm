...
section .data
;template			 0123456789abcdef0123456789abcdef0123456789abcde
;template			 12345678901234567890123456789012345678901234567                 						
...
.not_found:	
    ...
    ;thisis an error in the original source
