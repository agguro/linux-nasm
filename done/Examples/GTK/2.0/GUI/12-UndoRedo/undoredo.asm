;name : undoredo.asm
;
;build : /usr/bin/nasm -felf64 -Fdwarf -g -o undoredo.o undoredo.asm
;        ld --dynamic-linker /lib64/ld-linux-x86-64.so.2 -no-pie -melf_x86_64 -g -o undoredo undoredo.o -lc -lgtk-x11-2.0 -lgdk-x11-2.0 -lgobject-2.0 -lgdk_pixbuf-2.0 -lglib-2.0
;
