; Name        : disconnect.asm
;
;; Build      : nasm -felf64 -o disconnect.o -l disconnect.lst v.asm
;               ld -s -m elf_x86_64 disconnect.o -o disconnect -lc --dynamic-linker /lib64/ld-linux-x86-64.so.2 `pkg-config --libs gtk+-3.0`
;
