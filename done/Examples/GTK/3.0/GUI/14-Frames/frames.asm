; Name        : frames.asm
;
; Build       : nasm -felf64 -o frames.o -l frames.lst frames.asm
;               ld -s -m elf_x86_64 frames.o -o frames -lc --dynamic-linker /lib64/ld-linux-x86-64.so.2 -lgtk-3 -lgobject-2.0  -lglib-2.0 -lgdk_pixbuf-2.0 -lgdk-3
;
