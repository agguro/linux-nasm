...
; ==================================================================
	...
	%DEFINE VERSION '1.0'    	; OS version number
...
;	jmp execute_bin_program		; ...and move on to the executing part
        ...
        cmp     al, 0x4F
        jne     @graph_no_vga
        mov     si, graph_vga_present_msg
        jmp     @print
@graph_no_vga:
        mov     si, graph_no_vga_msg
@print:        
        call    os_print_string
...
;	jmp option_screen		; Offer menu/CLI choice after CLI has exited
	...
	os_init_msg		        db "PEM 1 Simulator by Agguro - Version ", VERSION, 10, 13, 0
	graph_no_vga_msg                db "This graphics adapter doesn't support sVGA", 10, 13, 0
        graph_vga_present_msg           db "sVGA Graphics adapter detected", 10, 13, 0
