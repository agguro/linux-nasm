/*
 * In our code example we use keyboard shortcuts.
 * The Ctrl+M shortcut highlights the all occurrences of the currently selected text.
 * The Ctrl+R removes the highlights from the text.
 */ 
