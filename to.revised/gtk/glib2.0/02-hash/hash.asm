;name        : hash.asm
;
;build       : nasm -felf64 -o hash.o -l hash.lst hash.asm
;              ld -m elf_x86_64 -g --dynamic-linker /lib64/ld-linux-x86-64.so.2 -lc -lgtk-3 -lglib-2.0 hash.o -o hash
;
