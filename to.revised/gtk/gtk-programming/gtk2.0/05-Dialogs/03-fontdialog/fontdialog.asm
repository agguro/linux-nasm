; Name        : fontdialog.asm
;
; Build       : nasm -felf64 -o fontdialog.o -l fontdialog.lst fontdialog.asm
;               ld -s -m elf_x86_64 fontdialog.o -o fontdialog -lc --dynamic-linker /lib64/ld-linux-x86-64.so.2 `pkg-config --libs gtk+-2.0`
;
