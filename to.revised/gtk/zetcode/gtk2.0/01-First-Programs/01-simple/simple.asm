; Name        : simple.asm
;
; Build       : nasm -felf64 -o simple.o -l simple.lst simple.asm
;				ld -m elf_x86_64 -g --dynamic-linker /lib64/ld-linux-x86-64.so.2 -lc -lgtk-x11-2.0 -lglib-2.0 -lgobject-2.0 -lgdk_pixbuf-2.0 -lgdk-x11-2.0 simple.o -o simple
;
