...
section .data
     ...
     dialog:
     .handle:       dq   0
     .title:        db   "Save File", 0
     
     ;deprecated!!!
     SAVE_FILE:  db   "gtk-save", 0
...
select_file:     
    ...
    %define GTK_RESPONSE_HELP          -11
     ...
     szSave:    db "_Save",0
     szUntitled: db "this_is_a_new_document",0
...
section .text
     ...
     extern gtk_file_chooser_set_do_overwrite_confirmation
     mov    rsi,TRUE
     mov    rdi,[dialog.handle]
     call   gtk_file_chooser_set_do_overwrite_confirmation
     
     ;if new document:
     ;assume [new] as a flag
     ;mov   rax,[new]
     ;and   rax,rax
     ;jz    .notnew
     ;new document
.new:
    extern gtk_file_chooser_set_current_name
    mov     rsi,szUntitled
    mov     rdi,[dialog.handle]
    call gtk_file_chooser_set_current_name
    jmp .save
.notnew:
    ;mov     rsi,szCurrentFilename
    ;mov     rdi,[dialog.handle]
    ;call gtk_file_chooser_set_file_name
.save:
