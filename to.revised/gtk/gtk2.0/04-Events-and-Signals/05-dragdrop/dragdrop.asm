; Name        : dragndrop.asm
;
; Build       : nasm -f elf64 -F dwarf -g ../dragdrop.asm -o dragdrop.o
;               ld -m elf_x86_64 -g --dynamic-linker /lib64/ld-linux-x86-64.so.2 -lc -lgtk-x11-2.0 -lglib-2.0 -lgobject-2.0 dragdrop.o -o dragdrop
;
; Description : The example demonstrates a drag and drop operation of a borderless window. 
;
