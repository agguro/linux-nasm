/*
 * not all icons can be viewed this way, a common error is assertion failed.
 * I solved this using Gimp image editor and "remake" the images.
 * The size is 32x32 and I've used transparence as background.  On the internet
 * I've found that it could be Linux theme related but I doubt that a bit.
 * Anyway, this works and I hope that the solution works in the future for all
 * of us.  It's an iconviewer so I don't use too large images anyway.
 */
#include <gtk/gtk.h>
#include <assert.h>
