; Name:         readfile
;
; Build:        nasm "-felf64" readfile.asm -l readfile.lst -o readfile.o
;               ld -s -melf_x86_64 -o readfile readfile.o 
;
; Description:  shows the contents of a file in plain text, quite the same as linux cat command   
