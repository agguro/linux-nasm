...
;
; Build:         nasm "-felf64" mysqldatabases.asm -l mysqldatabases.lst -o mysqldatabases.o 
;                ld -s -melf_x86_64 -o mysqldatabases mysqldatabases.o -lc --dynamic-linker /lib64/ld-linux-x86-64.so.2 -lmysqlclient
;
; Description:   Example how to query a mysql server.
;
; Remark:
; libmysqlclient is needed, to install execute sudo apt-get install libmysqlclient-dev
