...
;
; Description   : Demonstration on the file locking mechanism.
;
; Source        : http://beej.us/guide/bgipc/output/html/multipage/flocking.html
;                 converted from C
;
; Remark:
; Assemble and link the program. Keep the sourcefile lockdemo.asm in the same directory.
; Open two terminals and run in one terminal until 'got lock' appears (after first RETURN.
