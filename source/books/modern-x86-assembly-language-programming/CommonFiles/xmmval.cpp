/* build: g++ -c -m32 xmmval.cpp -o xmmval.o -std=c++11
...
{
	snprintf(s, len, "%25lld | %25lld", i64[0], i64[1]);
    return s;
}
...
{
	snprintf(s, len, "%25llu | %25llu", u64[0], u64[1]);
    return s;
}
...
{
	snprintf(s, len, "%04X %04X %04X %04X | %04X %04X %04X %04X",
        u16[0], u16[1], u16[2], u16[3],
        u16[4], u16[5], u16[6], u16[7]);
    return s;
}
...
{
	snprintf(s, len, "%08X %08X | %08X %08X",
        u32[0], u32[1], u32[2], u32[3]);
    return s;
}
...
{
	snprintf(s, len, "%25llX | %25llX", u64[0], u64[1]);
    return s;
}
...
{
	snprintf(s, len, "%24.12lf  | %24.12lf",
        r64[0], r64[1]);
    return s;
}
