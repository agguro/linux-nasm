...
int main()
{
	...
	printf("  des_len: %d (%d) des: %ls \n", des1_len, static_cast<int>(wcslen(des1_temp)), des1_temp);
	...
	printf("  des_len: %d (%d) des: %ls \n", des2_len, static_cast<int>(wcslen(des2_temp)), des2_temp);
	...
	printf("  des_len: %d (%d) des: %ls \n", des3_len, static_cast<int>(wcslen(des3_temp)), des3_temp);
