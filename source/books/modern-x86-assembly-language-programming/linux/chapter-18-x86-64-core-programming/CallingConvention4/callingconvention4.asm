...
;            r9     bsa3
    ...
    push    r14
    push    r15
    sub     rsp,8                           ;align stack to call pow
...
; Initialize registers unchanged by pow function
    ...
    mov     r14,r8                          ;bsa2
    mov     r15,r9                          ;bsa3
    ;register r9 is unchanged by pow function
    mov     r9,rdx                          ;n
...
.l1:
    ;xmm0 = 0.007184
    mov     rax,r8_0p007184 wrt ..gotoff
    movsd   xmm0,[rbx + rax]
    movsd   [r13+r10],xmm0
    ;xmm0 = 0.007184 * pow(ht, 0.725)
    movsd   xmm0,[r11+r10]                  ;xmm0 = height
    mov     rax,r8_0p725 wrt ..gotoff
    movsd   xmm1,[rbx + rax]
    call    pow wrt ..plt
    movsd   xmm1,[r13+r10]
    mulsd   xmm0,xmm1
...
; Calculate bsa2 = 0.0235 * pow(ht, 0.42246) * pow(wt, 0.51456)
    ...
    ;xmm0 = 0.0235
    mov     rax,r8_0p0235 wrt ..gotoff
    movsd   xmm0,[rbx + rax]
    movsd   [r14+r10],xmm0
    ;xmm0 = 0.0235 * pow(ht, 0.42246)
    movsd   xmm0,[r11+r10]                  ;xmm0 = height
    mov     rax,r8_0p42246 wrt ..gotoff
    movsd   xmm1,[rbx + rax]
    call    pow wrt ..plt
    movsd   xmm1,[r14+r10]
    mulsd   xmm0,xmm1
...
; Calculate bsa3 = sqrt(ht * wt) / 60.0;
    ...
    mulsd   xmm0,xmm1
    sqrtsd  xmm0,xmm0
    mov     rax,r8_60p0 wrt ..gotoff
    divsd   xmm0,[rbx + rax]                ;xmm0 = bsa3
