...
section .data
	...
	on_before_run_msg:	db		"app on before run.",10
		.len:			equ		$-on_before_run_msg
	on_after_run_msg:	db		"app on after run.",10
		.len:			equ		$-on_after_run_msg
	on_exit_msg:		db		"app on exit.",10
		.len:			equ		$-on_exit_msg
