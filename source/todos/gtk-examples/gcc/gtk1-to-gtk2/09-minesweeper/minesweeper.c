 ...
 */
static typMinesweeperButton mines[MAX_COLS][MAX_ROWS];

/* --- Flags for the game --- */
static int bGameOver = FALSE;            /* --- Game is over? --- */
static int bResetGame = FALSE;           /* --- Game is over? --- */
static int nBombsLeft;                   /* --- Undiscovered bombs --- */

static GtkWidget *table = NULL;          /* --- Table with the grid in it. --- */
static GtkWidget *button_start;          /* --- Start button --- */
static GtkWidget *label_bombs;           /* --- Label showing # of bombs left --- */
static GtkWidget *label_time;            /* --- Label showing # of bombs left --- */
static GtkWidget *vbox;                  /* --- main window's vbox --- */
...
void SetGrid (int nGridColumns, int nGridRows, int nBombs)
{
    ...
    table = gtk_table_new ((guint)nGridColumns, (guint)nGridRows, FALSE);
