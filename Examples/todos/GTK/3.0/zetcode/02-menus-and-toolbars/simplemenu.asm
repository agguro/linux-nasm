; Name        : simplemenu.asm
;
; Build       : nasm -felf64 -o simplemenu.o -l simplemenu.lst simplemenu.asm
;               ld -s -m elf_x86_64 simplemenu.o -o simplemenu -lc --dynamic-linker /lib64/ld-linux-x86-64.so.2
