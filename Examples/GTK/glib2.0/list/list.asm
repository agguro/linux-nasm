...
;
;build       :nasm -f elf64 -F dwarf -g list.asm -o list.o
;             ld -m elf_x86_64 -g --dynamic-linker /lib64/ld-linux-x86-64.so.2 -lc -lgtk-x11-2.0 -lgdk-x11-2.0 -lglib-2.0 list.o -o list
