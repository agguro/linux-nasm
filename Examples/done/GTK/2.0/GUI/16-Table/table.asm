...
;        ld --dynamic-linker /lib64/ld-linux-x86-64.so.2 -no-pie -melf_x86_64 -g -o table table.o -lc -lgtk-x11-2.0 -lgdk-x11-2.0 -lgobject-2.0 -lgdk_pixbuf-2.0 -lglib-2.0
;
...
.nextbutton:
    ...
    push	rbp			;add this to align stack
    push    rdi
    push    rsi
    push    rax
    push    rcx
