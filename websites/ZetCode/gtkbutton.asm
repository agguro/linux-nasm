; Name        : gtkbutton.asm
;
; Build       : nasm -felf64 -o gtkbutton.o -l gtkbutton.lst gtkbutton.asm
;               ld -s -m elf_x86_64 gtkbutton.o -o gtkbutton -lc --dynamic-linker /lib64/ld-linux-x86-64.so.2 -lgtk-3 -lgobject-2.0  -lglib-2.0 -lgdk_pixbuf-2.0 -lgdk-3 -lpango-1.0 -latk-1.0 -lgio-2.0 -lpangoft2-1.0
