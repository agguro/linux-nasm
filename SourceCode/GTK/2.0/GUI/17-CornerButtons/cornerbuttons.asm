;name : cornerbuttons.asm
;
;build : nasm -felf64 -o cornerbuttons.o -l cornerbuttons.lst cornerbuttons.asm
;               ld --dynamic-linker /lib64/ld-linux-x86-64.so.2 -no-pie -melf_x86_64 -g -o cornerbuttons cornerbuttons.o -lc -lgtk-x11-2.0 -lgdk-x11-2.0 -lgobject-2.0 -lgdk_pixbuf-2.0 -lglib-2.0
;
