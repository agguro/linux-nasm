...
section .rodata
    ...
    .len:           equ     $-stderrmsg
    stdoutmsg:      db      "stdout: message received press CTRL-C to exit",0x0A
    .len:           equ     $-stdoutmsg
...
.parent:
    ...
    syscall write,stderr,stderrmsg,stderrmsg.len
    syscall write,stdout,stdoutmsg,stdoutmsg.len
